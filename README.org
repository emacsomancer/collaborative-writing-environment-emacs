* Collaborative Writing with Emacs [[./_images/emacs-collab.png]]
...
* Notes
- migrated from: [[git@gitlab.com:emacsomancer/collaborative-writing-environment-emacs.git][git@gitlab.com:emacsomancer/collaborative-writing-environment-emacs.git]]
